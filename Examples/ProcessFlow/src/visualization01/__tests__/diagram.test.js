...
const config = {
  ...
  data :
  {
    ...
    "actors": [
      ...
      "phases": [
        {"id": "55-ED9AC05F80864AC8A286A611B42BC74E", "name": "Phase 1 - Identification and Definition of Support Influence and Change Requirements", "navigable": false},
        ...
        {"id": "55-4EE70459084D402799F66DC7BED89A23", "name": "Phase 5 -Close Out Remaining Safety Case and Supportability Case Requirements", "navigable": false}
      ], 
      "steps": [
        {
          ...
          "phase": {"id": "55-ED9AC05F80864AC8A286A611B42BC74E", "name": "Phase 1 - Identification and Definition of Support Influence and Change Requirements"}
        },
        {
        ...
        },
        {
          ...
          "name": "11. Update requirements and delivery plans where dependent on maturity of design change and other Elements.", 
          "type": "Process Step", 
          "navigable": true, 
          "swimlanes": [{"id": "x", "actor": {"id": "55-9FDC37967E4C4E74918A1D25401E39F0", "name": "Actor 2"}}], 
          "phase": {"id": "55-7422D300EE914A9FA03B61068CAC165E", "name": "Phase 3 - Manage Development and Delivery of Support Changes"}
        ...
        },
        {
          ...
          "name": "16. Do the outputs satisfy CCU requirements?", 
          "type": "Decision", 
          "navigable": true, 
        ...
        },
        {
          ...
          "navigable": true, 
          "swimlanes": [{"id": "x", "actor": {"id": "55-2FF0F06AFD054E1ABC21BBA52996E9FF", "name": "Design Change Owner (DCO)"}}], 
          "phase": {"id": "55-4EE70459084D402799F66DC7BED89A23", "name": "Phase 5 -Close Out Remaining Safety Case and Supportability Case Requirements"}
        },
        {
      ...
      "stepFlows": [
        ...
        },
        {
          ...
          "target": {"id": "55-DB727D85D512483DB7B7A81C905465FB", "name": "11. Update requirements and delivery plans where dependent on maturity of design change and other Elements."}, 
          "label": null, 
          "offPageConnection": false, 
          "offPageOutputLabel": null, 
          "offPageInputLabel": null
        },
        {
          ...
          "source": {"id": "55-DB727D85D512483DB7B7A81C905465FB", "name": "11. Update requirements and delivery plans where dependent on maturity of design change and other Elements."}, 
        ...
        },
        {
          ...
          "source": {"id": "55-FCB0C32F3CE54A2C9DB57D06A1DA4626", "name": "16. Do the outputs satisfy CCU requirements?"}, 
          "target": {"id": "55-B786779D5C8146FE89F7CEC4107F31F8", "name": "14. Produce and deliver Support Element outputs.  Conduct individual Support Element reviews/V&V as required."}, 
          "label": "No", 
          "offPageConnection": false, 
          "offPageOutputLabel": null, 
        ...
        },
        {
          ...
          "source": {"id": "55-97F2A2DE7A6941698EAE78367ED5406B", "name": "15. Is the output required for the CCU?"}, 
          "target": {"id": "55-FCB0C32F3CE54A2C9DB57D06A1DA4626", "name": "16. Do the outputs satisfy CCU requirements?"}, 
          "label": "Yes", 
          "offPageConnection": false, 
          "offPageOutputLabel": null, 
          "offPageInputLabel": null
...
describe('Diagram', () => {
    const mockGraphCreateElement = jest.fn()
    const mockGraphCreateLabel = jest.fn()
    const mockGraphCreateActorLane = jest.fn()
    const mockGraphCreateSwimlane = jest.fn()
    const mockGraphCreatePhaseMarker = jest.fn()
    const mockGraphCreateFlow = jest.fn()
    const mockGraphCreateIOLink = jest.fn()
    const mockGraphDraw = jest.fn().mockReturnValue({})
    beforeAll(() => {
        Graph.Graph.mockImplementation(() => {
          return {
            createElement: mockGraphCreateElement,
            createLabel: mockGraphCreateLabel,
            createActorLane: mockGraphCreateActorLane,
            createSwimlane: mockGraphCreateSwimlane,
            createPhaseMarker: mockGraphCreatePhaseMarker,
            createFlow: mockGraphCreateFlow,
            createIOLink: mockGraphCreateIOLink,
            draw: mockGraphDraw
            }
          })
      })
    ...
    it('Successful create', () => {
      ...
      expect(Graph.Graph).not.toHaveBeenCalled()
    })
    it('Successful draw', () => {
        let throwCount = 0
        mockGraphCreateSwimlane
            .mockReturnValueOnce({
                position: function () {
                  return {
                    x: 0,
        ...
        mockGraphCreateElement.mockReturnValue({
            getPortPosition: function (portId) {
                return {
                    x: 0,
                    y: 30
                }
            },
            getPortId: function (portGroupName, portIndex) {
                return 'PortId-1'
            }
        })
                document.body.innerHTML =
