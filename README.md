...
This will create the visualization package zip file `visualization-<version number>.zip` in the top level folder of your VS Code workspace. Before importing into MooD, you will probably want to rename this if you didn't do so when following the template customisation guide. You can change the name of the package file that is generated by updating the *ZipFilesPlugin* defined in `webpack.prod.js`
